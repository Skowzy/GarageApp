    ...
    <div class="grid md:grid-cols-3 gap-6">
        <?php foreach ($userCars as $car): ?>
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="p-6">
                    <h2 class="text-xl font-semibold mb-2 text-blue-900"><?php echo $car->getBrand() . ' ' . $car->getModel(); ?></h2>
                    <p class="text-gray-600 mb-4">Année : <?php echo $car->getYear(); ?></p>
                    <div class="flex justify-between items-center">
                        <a href="?ctrl=car&action=show&id=<?php echo $car->getId(); ?>" class="text-blue-600 hover:text-blue-800">
                            <i class="fas fa-info-circle mr-1"></i> Détails
                        </a>
                        <span class="text-sm text-gray-500">
                            <i class="fas fa-wrench mr-1"></i> Dernier entretien : <?php echo $car->getLastMaintenanceDate(); ?>
                        </span>
                    </div>
                </div>
                <div class="bg-gray-100 px-6 py-4">
                    <a href="?ctrl=actions&action=create&car_id=<?php echo $car->getId(); ?>" class="text-blue-600 hover:text-blue-800">
