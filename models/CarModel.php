...
class CarModel extends CoreModel
{
    ...
    {
        $sql = "INSERT INTO car (car_brandId, car_modelId, car_year,car_kilometers,car_fuelType,car_licensePlate, car_useId) 
        ...
        try {
            ...
            if ($this->_req) {
                $this->_req->bindValue(':brand', $request['brand'], PDO::PARAM_INT);
                $this->_req->bindValue(':model', $request['model'], PDO::PARAM_INT);
    ...
    {
        $sql = "SELECT car_id, mod_label AS car_model, bra_label AS car_brand, car_year, car_kilometers, car_fuelType, car_licensePlate, car_notes 
                FROM car 
                JOIN model ON car_modelId = mod_id
                JOIN brand ON car_brandId = brand.bra_id
                WHERE car_id = :id ";
    ...
    {
        $sql = "UPDATE car
                SET car_year = :year, car_kilometers = :kilometers, car_fuelType = :fuelType,car_licensePlate = :licensePlate, car_notes = :notes
                WHERE car_id = :id";
